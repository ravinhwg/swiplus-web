...
export default function Search({ deckId, blurhashImages, metaData }) {
  ...
  const userDecks = useInfiniteQuery(
    ["getUserDecks", deckQuery.data?.deck?.username],
    getUserDecks,
    {
      enabled: !!deckQuery.data?.deck?.username,
    }
  );
  useEffect(() => {
                ...
                <div className="lg:flex w-full lg:w-8/12">
                  <div className="lg:w-6/12">
                    <div className="flex flex-row m-3 justify-start">
                      ...
                      />
                      <div className="w-full text-xl text-gray-200 self-center font-inter font-medium">
                  ...
                  <div className="lg:w-6/12 lg:mt-10 lg:h-3/6 lg:overflow-scroll">
