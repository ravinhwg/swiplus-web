...
export default function ShareDialogBox(props) {
  return (
              ...
              <>
                ...
                <div className="text-sm  text-gray-200 max-w-md justify-center px-5 md:justify-left ">
                  <input
                    ...
                    type="text"
                    value={`${props.url}?utm_source=linkbox&utm_medium=sharebutton&utm_campaign=deck_share`}
                  />
                </div>
                <div className="text-sm flex text-gray-200 mt-1 w-full justify-center overflow-scroll  ">
                  <div className=" sm:ml-0 ml-36 m-3 flex flex-col justify-between items-center">
                    <FacebookShareButton
                      url={`${props.url}?utm_source=facebook&utm_medium=sharebutton&utm_campaign=deck_share`}
                      quote={props.title}
                    >
                  ...
                  <div className="m-3 flex flex-col justify-between items-center">
                    <TwitterShareButton
                      url={`${props.url}?utm_source=twitter&utm_medium=sharebutton&utm_campaign=deck_share`}
                      title={props.title}
                    >
                  ...
                  <div className="m-3 flex flex-col justify-between items-center">
                    <WhatsappShareButton
                      url={`${props.url}?utm_source=whatsapp&utm_medium=sharebutton&utm_campaign=deck_share`}
                      title={props.title}
                    >
                  ...
                  <div className="m-3 flex flex-col justify-between items-center">
                    <RedditShareButton
                      url={`${props.url}?utm_source=reddit&utm_medium=sharebutton&utm_campaign=deck_share`}
                      title={props.title}
                      windowWidth={660}
                      windowHeight={460}
                  ...
                  <div className="m-3 flex flex-col justify-between items-center">
                    <PinterestShareButton
                      url={`${props.url}?utm_source=pinterest&utm_medium=sharebutton&utm_campaign=deck_share`}
                      media={props.media}
                      className="Demo__some-network__share-button"
                    >
                  ...
                  <div className="m-3 flex flex-col justify-between items-center">
                    <EmailShareButton
                      url={`${props.url}?utm_source=email&utm_medium=sharebutton&utm_campaign=deck_share`}
                      subject={props.title}
                      body="body"
                      className="Demo__some-network__share-button"
                    >
